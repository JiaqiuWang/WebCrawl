        ...
        while flag:
            ...
            if not (new_latent_count > 0):
                ...
                mobile_next_url = "https://mobile.twitter.com/i/rw/profile/timeline?" \
                                  "max_id="+mobile_id+"&screen_name="+self.user_name+"&type=tweets"
...
def main_operation():
    ...
    # max_position参数
    max_position = "674119217931665408"
    # 用户名
    user_name = "ghewgill"
    url = "https://twitter.com/i/profiles/show/"+user_name+"/timeline/with_replies?" \
          "include_available_features=1&include_entities=1" \
          "&max_position="+max_position+"&reset_error_state=false"
    # 写入文件名
    filename = "post.txt"
    """Part2: 循环获取"""
